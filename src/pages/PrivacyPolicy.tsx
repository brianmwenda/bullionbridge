      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="prose max-w-none text-gray-700 space-y-6">
          <section>
            ...
            <p>At BullionBridge, we collect information you provide directly to us, such as when you create an account, make a purchase, or contact us for support. This includes:</p>
          ...
          <section>
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              <p><strong>Email:</strong> privacy@bullionbridge.com</p>
