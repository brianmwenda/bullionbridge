...
const LearnMore = () => {
  ...
  const whyChooseUs = [
    ...
    },
    {
      ...
      description: "We offer competitive buyback prices for products purchased through BullionBridge."
    }
  ];
  ...
  return (
    ...
    <div className="min-h-screen">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Choose BullionBridge?</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
